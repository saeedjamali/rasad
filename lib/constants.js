...
export const REQUEST_EXCEL_ROLES = [
  ROLES.admin,
  ROLES.province_transfer,
  ROLES.district_transfer,
  ROLES.province_planning,
  ROLES.hr_manager,
  ROLES.director_general,
];

export const SYSTEM_ACCESS_ROLES = [
  ROLES.personnel,
  ROLES.province_transfer,
  ROLES.district_transfer,
  ROLES.province_planning,
...
export const REPORT_STATS_ROLES = [
  ROLES.province_transfer,
  ROLES.hr_manager,
  ROLES.director_general,
  ROLES.admin,
...
export const SESSION_ACTIVE_MS = 15 * 60 * 1000;
...
export const STATUS_LABELS = {
  ...
  INQUIRY_RESPONSE_WAITING_PROVINCE:
    "پاسخ به استعلام استان – در انتظار بررسی استان",
...
export const ACTION_LABELS = {
  ...
  session_revoke: "بستن نشست",
  session_revoke_all: "بستن همه نشست‌ها",
  ...
  request_results_import: "بارگذاری گروهی نتایج درخواست",
...
export function missingApplicantRequired(body) {
  ...
  if (!body?.districtCode && !body?.originDistrict)
    return "منطقه مبدا الزامی است";
...
export const LOCKED_USER_MESSAGE =
  "حساب کاربری شما قفل شده است. با مدیر سیستم تماس بگیرید.";

export const DISABLED_USER_MESSAGE =
  "حساب کاربری شما غیرفعال شده است. با مدیر سیستم تماس بگیرید.";

export const MAINTENANCE_MESSAGE =
  "سامانه در حال به‌روزرسانی است. لطفاً کمی بعد مراجعه کنید.";

export const REQUEST_SUBMIT_CLOSED_MESSAGE =
  "ثبت درخواست انتقال فعلاً غیرفعال است.";

export const REVIEW_RESULT_USER_MESSAGE =
  "فرایند بررسی درخواست شما نهایی شد و نتیجه انتقال ،  متعاقبا در سامانه مای‌ مدیو نیز بروز خواهد شد.";
...
export const MENU = [
  { href: "/app", label: "صفحه اصلی", roles: Object.values(ROLES) },
  {
    href: "/app/request",
    label: "درخواست من",
    roles: [ROLES.personnel, ROLES.admin],
  },
  {
    href: "/app/applicants",
    label: "متقاضیان",
    roles: [ROLES.province_transfer, ROLES.district_transfer, ROLES.admin],
  },
