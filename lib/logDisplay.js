...
const FIELD_LABELS = {
  ...
  isActive: "فعال",
  isVisible: "نمایش",
  resultNote: "توضیحات بررسی نهایی",
  resultDestCode: "کد مقصد نهایی",
  resultDestName: "مقصد نهایی منتقل شده",
  destName: "مقصد نهایی",
  destCode: "کد مقصد نهایی",
  isLocked: "قفل",
  ...
  allowRequestSubmit: "ثبت درخواست انتقال",
  allowMultiMainCategory: "انتخاب چند دسته اصلی",
  maxMainCategories: "سقف انتخاب دسته اصلی",
  allowRequestExcelExport: "خروجی اکسل درخواست‌ها",
  allowReportLookup: "جستجوی پرونده در گزارش‌ها",
...
function fieldLabel(key) {
  return FIELD_LABELS[key] || ROLE_LABELS[key] || key;
}
